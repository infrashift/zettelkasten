...
If you need to revert a tethered note back to untethered, press `\t` and select `untether`.
...
This shows an ASCII tree of up to 20 nodes and their relationships in a scratch buffer. Press `q` to close.
